(() => {
    ...
    function menuInit() {
        if (document.querySelector(".menu--btn")) document.addEventListener("click", (function(e) {
    ...
    let filterBtn = document.querySelector(".mobile__filter--title");
    let filterBtnClose = document.querySelector(".filter__close");
